...
/**
 * Navigation items derived from the schema stages and system features.
 * In production these would come from the SchemaRegistry API.
 */
...
export function Sidebar() {
  ...
  return (
    <aside
      className="hidden tablet:flex tablet:w-64 desktop:w-72 flex-col
                 border-r border-[rgb(var(--sidebar-border))]
                 bg-[rgb(var(--sidebar))] h-screen sticky top-0"
      aria-label="Main navigation"
    >
      {/* Logo / Brand */}
      <div className="flex h-16 items-center gap-2 px-6 border-b border-[rgb(var(--sidebar-border))]">
        <div className="h-8 w-8 rounded-lg bg-[rgb(var(--accent))] flex items-center justify-center">
          <span className="text-sm font-bold text-[rgb(var(--accent-foreground))]">G</span>
        </div>
      ...
      {/* Bottom section */}
      <div className="border-t border-[rgb(var(--sidebar-border))] px-3 py-4">
        <div className="flex items-center justify-between px-3">
          <span className="text-xs text-[rgb(var(--muted-foreground))]">v2.0.0</span>
          <ThemeToggle />
        </div>
      </div>
    </aside>
